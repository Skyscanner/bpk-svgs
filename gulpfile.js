...
import getIconFontMetadataProvider from './tasks/getIconFontMetadataProvider.js';
import metadata from './tasks/metadata/index.js';
import svg2react from './tasks/svg2react.js';
...
const tokenFileURL = new URL("./node_modules/@skyscanner/bpk-foundations-web/tokens/base.raw.json", import.meta.url);
const tokens = JSON.parse(await readFile(tokenFileURL, 'utf8'));

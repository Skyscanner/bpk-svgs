...
export const callBackSvg = (props: Props) => {
  return (
    ...
    >
      ...
      <path d="M14.164 8.32a1.037 1.037 0 0 1-.05 1.413L12.817 11h8.233c.524 0 .95.448.95 1s-.425 1-.95 1h-8.233l1.297 1.267c.385.376.407 1.009.05 1.414a.92.92 0 0 1-1.343.052l-3.089-3.018a1 1 0 0 1 0-1.43l3.089-3.018a.92.92 0 0 1 1.343.053" />
    </svg>
  );
};
